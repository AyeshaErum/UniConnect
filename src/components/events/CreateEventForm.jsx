...
export default function CreateEventForm({ onClose }) {
  ...
  const [form, setForm] = useState({
    title: '', description: '', type: '', date: '', location: '', maxParticipants: '',
  })
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Input label="Max Participants" type="number" min="2" value={form.maxParticipants} onChange={e => set('maxParticipants', e.target.value)} placeholder="Leave blank = unlimited" />
      </div>
